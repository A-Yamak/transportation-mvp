...
class DestinationItemResource extends ApiResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'line_total' => $this->resource->line_total ? (float) $this->resource->line_total : null,
            'delivered_total' => $this->resource->delivered_total ? (float) $this->resource->delivered_total : null,
